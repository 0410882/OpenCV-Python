...
class TrafficCounting:
    ...
    #set calculate Lines
    calculateRange_y = 0
    calculateLine1 = [[] for i in range(2)]
    calculateLine2 = [[] for i in range(2)]
    ...
    def select_region(self, image):
        ...
        pt_1l = [cols * 0.15, rows * 0.44]
        pt_2l = [cols * 0.15, rows * 0.60]
        pt_3l = [cols * 0.49, rows * 0.60]
        pt_4l = [cols * 0.49, rows * 0.44]
		
        pt_1r = [cols * 0.51, rows * 0.44]
        pt_2r = [cols * 0.51, rows * 0.60]
        pt_3r = [cols * 0.85, rows * 0.60]
        pt_4r = [cols * 0.85, rows * 0.44]

        self.calculateLine1[0] = [cols * 0.15, rows * 0.52]
        self.calculateLine1[1] = [cols * 0.49, rows * 0.52]
        self.calculateLine2[0] = [cols * 0.51, rows * 0.52]
        self.calculateLine2[1] = [cols * 0.85, rows * 0.52]
        self.calculateRange_y = rows * 0.08
